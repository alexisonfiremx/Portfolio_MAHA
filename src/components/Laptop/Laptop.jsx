...
return (
    <web.main className='laptop__size ' style={{ background: props.open.to([0, 1], ['#2b294b', '#2b294b']) }}>
    <web.h1 className="head-text for__title" style={{ opacity: props.open.to([0, 1], [1, 0]) }}>
        click me 👇
    </web.h1>
